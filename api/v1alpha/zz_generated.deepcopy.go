...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConduitPodTemplate) DeepCopyInto(out *ConduitPodTemplate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConduitPodTemplate.
func (in *ConduitPodTemplate) DeepCopy() *ConduitPodTemplate {
	if in == nil {
		return nil
	}
	out := new(ConduitPodTemplate)
	in.DeepCopyInto(out)
	return out
}
